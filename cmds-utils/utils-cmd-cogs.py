...
class Cogs(commands.Cog):
    ...
    async def cogload(
        ...
        cog: str = commands.Param(
            desc="Enter the cog/extension to be loaded into the bot.",
            autocomp=autocomp_unloadedcogs,
        ),
    ):
    ...
    async def cogunload(
        ...
        ctx: ApplicationCommandInteraction,
        cog: str = commands.Param(
            desc="Enter the cog/extension to be unloaded from the bot.",
            autocomp=autocomp_loadedcogs,
        ),
    ):
    ...
    async def cogreload(
        ...
        ctx: ApplicationCommandInteraction,
        cog: str = commands.Param(
            desc="Enter the cog/extension to be reloaded into the bot.",
            autocomp=autocomp_loadedcogs,
        ),
    ):
