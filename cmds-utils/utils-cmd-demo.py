    ...
    @commands.slash_command(
        ...
        options=[
            ...
            Option(
                ...
                choices=[
                    OptionChoice(name="Choice 1", value="choice_1"),
                    OptionChoice(name="Choice 2", value="choice_2"),
                ],
                required=False,
            ),
            Option(
            ...
            Option(
                ...
                choices=[
                    OptionChoice(name="Choice 1", value=1),
                    OptionChoice(name="Choice 2", value=2),
                ],
                required=False,
            ),
            Option(
            ...
            Option(
                ...
                choices=[
                    OptionChoice(name="Integer Choice 1", value=1),
                    OptionChoice(name="Integer Choice 2", value=2),
                    OptionChoice(name="Float Choice 1", value=0.1),
                    OptionChoice(name="Float Choice 2", value=0.2),
                ],
                required=False,
            ),
        ],
